...
<h2 align="center">🇮🇩 Indonesia 🤝🏻 Philippines 🇵🇭</h2>
...
- Access to essential open space with less building, roadside vegetation
...
## Design Process
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/adelaamandari/web-images@main/design-process.png" />
</p>

Meant for short-term use. A tent-like structures for displaced families that can be use for a few weeks following a disaster, and it is easy to constructing this kind of shelter.

In order to make use of the materials that was used in temporary shelter, transitional shelters will be made by combining temporary shelter units so that displaced members of the society will have a transitional place.

<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/adelaamandari/web-images@main/design-process2.png" />
</p>

<p align="center">**Buildability** - can be easily constructed/replicated by locals</p>
<p align="center">**Availability** - can be built immediately after disaster</p>
<p align="center">**Versatility** - can be combined together to become a larger space</p>

**CONCLUSION** : a design that can be indepedently created, modified, replaced, or exchanged with other modules or between different systems.

**CONCEPT** : Umbrella. Like an umbrella when rainy day, a design that can easily used straight away when the disaster happen, can even be used multiple time.

<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/adelaamandari/web-images@main/pers-view.png" />
</p>
<p align="center">*Perspective View*</p>